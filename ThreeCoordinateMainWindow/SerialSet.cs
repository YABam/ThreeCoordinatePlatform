		...
		private void SerialSet_Load(object sender, EventArgs e)//窗体初始化
		{
			if (_mySP.IsOpen == true)//如果串口已经打开了
			{
				...
				switch (_mySP.StopBits)//设定停止位
				{
					...
					case StopBits.One:cbStopBits.SelectedIndex = 1;break;
					case StopBits.OnePointFive:cbStopBits.SelectedIndex = 2;break;
					case StopBits.Two:cbStopBits.SelectedIndex = 3;break;
				}
